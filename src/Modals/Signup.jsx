...
function Signup({ show, handleClose }) {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            if (!signupfetch.ok) {
                alert("there is some eror")
            }

            if(signupfetch.ok){
                toast.success('User is Signuped')
            }
    ...
    return (
        <>
            ...
            {/* Custom CSS overrides for the Red & Black aggressive theme */}
            <style>{`
        .modal-backdrop {
            ...
            >
                ...
                <Modal.Body className="pt-4">
                    <Form onSubmit={handleSubmit(onSubmit)} noValidate>
                        ...
                        <div className=" col-11 gap-4 d-flex">
                            <Form.Group className="mb-4 col-6 me-2" controlId="loginPassword">
                        ...
                        <Form.Group className="mb-4 col-6" controlId="loginPassword">
                            <div className="d-flex justify-content-between align-items-center">
                                <Form.Label className="text-uppercase text-light opacity-75 small fw-bold tracking-wide mb-1">
                                    Confirm Password
                                </Form.Label>
